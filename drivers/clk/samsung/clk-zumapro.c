...
#define CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI6_USI_IPCLKPORT_PCLK \
								0x209c
#define CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI2_USI_IPCLKPORT_PCLK \
								0x207c
#define CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI3_USI_IPCLKPORT_PCLK \
								0x2084
#define CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI4_USI_IPCLKPORT_PCLK \
								0x208c
#define CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI5_USI_IPCLKPORT_PCLK \
								0x2094
...
static const struct samsung_div_clock peric0_div_clks[] __initconst = {
	...
	DIV_F(CLK_DOUT_PERIC0_USI2_USI, "dout_peric0_usi2_usi",
	      "mout_peric0_usi2_usi_user",
	      CLK_CON_DIV_DIV_CLK_PERIC0_USI2_USI, 0, 4,
	      CLK_SET_RATE_PARENT, 0),
	DIV_F(CLK_DOUT_PERIC0_USI3_USI, "dout_peric0_usi3_usi",
	      "mout_peric0_usi3_usi_user",
	      CLK_CON_DIV_DIV_CLK_PERIC0_USI3_USI, 0, 4,
	      CLK_SET_RATE_PARENT, 0),
	DIV_F(CLK_DOUT_PERIC0_USI4_USI, "dout_peric0_usi4_usi",
	      "mout_peric0_usi4_usi_user",
	      CLK_CON_DIV_DIV_CLK_PERIC0_USI4_USI, 0, 4,
	      CLK_SET_RATE_PARENT, 0),
	DIV_F(CLK_DOUT_PERIC0_USI5_USI, "dout_peric0_usi5_usi",
...
static const struct samsung_gate_clock peric0_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_PERIC0_USI6_USI_CLK,
	     ...
	     CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI6_USI_IPCLKPORT_CLK,
	     21, CLK_SET_RATE_PARENT, 0),
	/* The four camera HS-I2C buses: ultrawide, front, aux and main. */
	GATE(CLK_GOUT_PERIC0_USI2_USI_PCLK,
	     "gout_peric0_usi2_usi_pclk", "mout_peric0_noc_user",
	     CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI2_USI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PERIC0_USI2_USI_CLK,
	     "gout_peric0_usi2_usi_clk", "dout_peric0_usi2_usi",
	     CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI2_USI_IPCLKPORT_CLK,
	     21, CLK_SET_RATE_PARENT, 0),
	GATE(CLK_GOUT_PERIC0_USI3_USI_PCLK,
	     "gout_peric0_usi3_usi_pclk", "mout_peric0_noc_user",
	     CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI3_USI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PERIC0_USI3_USI_CLK,
	     "gout_peric0_usi3_usi_clk", "dout_peric0_usi3_usi",
	     CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI3_USI_IPCLKPORT_CLK,
	     21, CLK_SET_RATE_PARENT, 0),
	GATE(CLK_GOUT_PERIC0_USI4_USI_PCLK,
	     "gout_peric0_usi4_usi_pclk", "mout_peric0_noc_user",
	     CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI4_USI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PERIC0_USI4_USI_CLK,
	     "gout_peric0_usi4_usi_clk", "dout_peric0_usi4_usi",
	     CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI4_USI_IPCLKPORT_CLK,
	     21, CLK_SET_RATE_PARENT, 0),
	GATE(CLK_GOUT_PERIC0_USI5_USI_PCLK,
	     "gout_peric0_usi5_usi_pclk", "mout_peric0_noc_user",
	     CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI5_USI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PERIC0_USI5_USI_CLK,
	     "gout_peric0_usi5_usi_clk", "dout_peric0_usi5_usi",
	     CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI5_USI_IPCLKPORT_CLK,
	     21, CLK_SET_RATE_PARENT, 0),
};
...
#define CLK_CON_MUX_MUX_CLK_HSI0_USI3		0x1020
...
#define CLK_CON_GAT_CLK_BLK_HSI0_UID_USI2_HSI0_IPCLKPORT_PCLK \
							0x2100
#define CLK_CON_GAT_CLK_BLK_HSI0_UID_USI3_HSI0_IPCLKPORT_IPCLK \
							0x2104
#define CLK_CON_GAT_CLK_BLK_HSI0_UID_USI3_HSI0_IPCLKPORT_PCLK \
							0x2108
...
PNAME(mout_hsi0_usi3_p) = { "mout_hsi0_peri_user", "oscclk" };
...
static const struct samsung_mux_clock hsi0_mux_clks[] __initconst = {
	...
	nMUX(CLK_MOUT_HSI0_USI3, "mout_hsi0_usi3",
	     mout_hsi0_usi3_p, CLK_CON_MUX_MUX_CLK_HSI0_USI3, 0, 1),
...
static const struct samsung_div_clock hsi0_div_clks[] __initconst = {
	...
	DIV_F(CLK_DOUT_HSI0_USI3, "dout_hsi0_usi3", "mout_hsi0_usi3",
	      CLK_CON_DIV_DIV_CLK_HSI0_USI3, 0, 4, CLK_SET_RATE_PARENT, 0),
...
static const struct samsung_gate_clock hsi0_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_HSI0_USI2_USI_PCLK, "gout_hsi0_usi2_usi_pclk",
	     ...
	     CLK_CON_GAT_CLK_BLK_HSI0_UID_USI2_HSI0_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI0_USI3_USI_CLK, "gout_hsi0_usi3_usi_clk",
	     "dout_hsi0_usi3",
	     CLK_CON_GAT_CLK_BLK_HSI0_UID_USI3_HSI0_IPCLKPORT_IPCLK,
	     21, CLK_SET_RATE_PARENT, 0),
	GATE(CLK_GOUT_HSI0_USI3_USI_PCLK, "gout_hsi0_usi3_usi_pclk",
	     "mout_hsi0_noc_user",
	     CLK_CON_GAT_CLK_BLK_HSI0_UID_USI3_HSI0_IPCLKPORT_PCLK,
	     21, 0, 0),
