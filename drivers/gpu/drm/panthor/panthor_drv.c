 ...
 */
static const char * const zumapro_opp_clk_names[] = { "core", "coregroup", NULL };

static const struct panthor_soc_data soc_data_google_zumapro = {
	.asn_hash_enable = true,
	.asn_hash = { 0x0036db6d, 0x005b6db6, 0x0, },
	.opp_clk_names = zumapro_opp_clk_names,
};

static const struct of_device_id dt_match[] = {
	{ .compatible = "mediatek,mt8196-mali", .data = &soc_data_mediatek_mt8196, },
	{ .compatible = "google,zumapro-mali", .data = &soc_data_google_zumapro, },
