 ...
 * the parameters node and the encoders that read a buffer from it,
 * exynos-becore-generated.c the words the driver states for a register no
 * buffer describes, exynos-becore-geometry.c the three rasters and the
 * surfaces derived from them, and exynos-becore-recipe.c the captured program
 * -- what is checked about one and how the four sources of a word are applied
 * into it.  exynos-becore-common.h is what they share; exynos-becore-regs.h is
 * the silicon.
 */
