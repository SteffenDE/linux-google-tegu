...
#define S5P_FIMV_D_DECODED_STATUS_V16		0xf644
#define S5P_FIMV_D_NUM_TILES_MASK_V16		GENMASK(18, 15)
#define S5P_FIMV_D_H264_INFO_V16			0xf690
#define S5P_FIMV_D_MBAFF_V16			BIT(9)
