...
/*
 * Q11: 2048 is 1.0. The hardware field is 13 bits wide, so a coefficient is
 * limited to [-4096, 4095] and the driver refuses anything outside it.
 */
#define EXYNOS_BECORE_CCM_ONE			2048
#define EXYNOS_BECORE_CCM_MIN			-4096
#define EXYNOS_BECORE_CCM_MAX			4095
 ...
 * arithmetic mistake in userspace than an intention.
 */
