 ...
 */
#define regulator_desc_s2mpg14_ldo_cmn(_num, _vsel_reg, _n_volt,	\
					   _grp, _en_reg, _en_mask)		\
	[S2MPG14_LDO##_num] = {						\
		.name		= "ldo" #_num "m",			\
		...
		.owner		= THIS_MODULE,				\
		.n_voltages	= _n_volt,				\
		.min_uV		= S2MPG14_REG_MIN##_grp,		\
		.uV_step	= S2MPG14_REG_STEP##_grp,		\
		.vsel_reg	= S2MPG14_PMIC_##_vsel_reg,		\
		.vsel_mask	= (_n_volt) - 1,			\
...
#define regulator_desc_s2mpg14_ldo(_num, _n_volt, _grp)			\
	regulator_desc_s2mpg14_ldo_cmn(_num, L##_num##M_CTRL,	\
					_n_volt, _grp,			\
					L##_num##M_CTRL, BIT(7))

/* enable is the operating mode in bits 7:6 of the rail's own CTRL register */
#define regulator_desc_s2mpg14_ldo_opmode(_num, _n_volt, _grp)		\
	regulator_desc_s2mpg14_ldo_cmn(_num, L##_num##M_CTRL,	\
					_n_volt, _grp,			\
					L##_num##M_CTRL, GENMASK(7, 6))
 ...
 */
#define regulator_desc_s2mpg14_buck_cmn(_id, _sfx, _vsel_reg,	\
					    _n_volt, _grp, _en_reg, _en_mask)	\
	[S2MPG14_BUCK##_id] = {						\
		.name		= "buck" #_sfx,				\
...
static const struct regulator_desc s2mpg14_regulators[] = {
	...
	regulator_desc_s2mpg14_ldo(1, 128, 2),
	regulator_desc_s2mpg14_ldo(2, 64, 4),
	regulator_desc_s2mpg14_ldo_cmn(3, L3M_CTRL1, 128, 2, L3M_CTRL1, BIT(7)),
	regulator_desc_s2mpg14_ldo(4, 64, 5),
	regulator_desc_s2mpg14_ldo_opmode(5, 64, 4),
	regulator_desc_s2mpg14_ldo_opmode(6, 64, 3),
	regulator_desc_s2mpg14_ldo(7, 64, 5),
	regulator_desc_s2mpg14_ldo_cmn(8, L8M_CTRL, 128, 2, LDO_CTRL1, GENMASK(1, 0)),
	regulator_desc_s2mpg14_ldo_opmode(9, 64, 3),
	regulator_desc_s2mpg14_ldo(10, 64, 3),
	regulator_desc_s2mpg14_ldo_cmn(11, L11M_CTRL1, 128, 2, LDO_CTRL1, GENMASK(3, 2)),
	regulator_desc_s2mpg14_ldo_cmn(12, L12M_CTRL1, 128, 2, LDO_CTRL1, GENMASK(5, 4)),
	regulator_desc_s2mpg14_ldo_cmn(13, L13M_CTRL1, 128, 2, LDO_CTRL1, GENMASK(7, 6)),
	regulator_desc_s2mpg14_ldo(14, 64, 5),
	regulator_desc_s2mpg14_ldo_cmn(15, L15M_CTRL1, 128, 2, LDO_CTRL2, GENMASK(1, 0)),
	regulator_desc_s2mpg14_ldo_opmode(16, 64, 3),
	regulator_desc_s2mpg14_ldo_cmn(17, L17M_CTRL1, 128, 2, LDO_CTRL2, GENMASK(3, 2)),
	regulator_desc_s2mpg14_ldo_opmode(18, 64, 3),
	regulator_desc_s2mpg14_ldo_opmode(19, 64, 5),
	regulator_desc_s2mpg14_ldo_opmode(20, 64, 4),
	regulator_desc_s2mpg14_ldo(21, 64, 5),
	regulator_desc_s2mpg14_ldo(22, 64, 3),
	regulator_desc_s2mpg14_ldo_opmode(23, 64, 4),
	regulator_desc_s2mpg14_ldo(24, 64, 4),
	regulator_desc_s2mpg14_ldo(25, 64, 4),
	regulator_desc_s2mpg14_buck_cmn(1, 1m, B1M_OUT1, 256, 1, B1M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(2, 2m, B2M_OUT1, 256, 1, B2M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(3, 3m, B3M_OUT1, 256, 1, B3M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(4, 4m, B4M_OUT1, 256, 1, B4M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(5, 5m, B5M_OUT1, 256, 1, B5M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(6, 6m, B6M_OUT1, 256, 1, B6M_CTRL, BIT(7)),
	regulator_desc_s2mpg14_buck_cmn(7, 7m, B7M_OUT0, 256, 1, B7M_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg14_buck_cmn(8, 8m, B8M_OUT1, 256, 1, B8M_CTRL, BIT(7)),
...
#define regulator_desc_s2mpg15_ldo_cmn(_num, _vsel_reg, _n_volt,	\
					   _grp, _en_reg, _en_mask)		\
	[S2MPG15_LDO##_num] = {						\
		.name		= "ldo" #_num "s",			\
		...
		.owner		= THIS_MODULE,				\
		.n_voltages	= _n_volt,				\
		.min_uV		= S2MPG15_REG_MIN##_grp,		\
		.uV_step	= S2MPG15_REG_STEP##_grp,		\
		.vsel_reg	= S2MPG15_PMIC_##_vsel_reg,		\
		.vsel_mask	= (_n_volt) - 1,			\
...
/* enable is plain on/off in bit 7 of the rail's own CTRL register */
#define regulator_desc_s2mpg15_ldo(_num, _n_volt, _grp)			\
	regulator_desc_s2mpg15_ldo_cmn(_num, L##_num##S_CTRL,	\
					_n_volt, _grp,			\
					L##_num##S_CTRL, BIT(7))

/* enable is the operating mode in bits 7:6 of the rail's own CTRL register */
#define regulator_desc_s2mpg15_ldo_opmode(_num, _n_volt, _grp)		\
	regulator_desc_s2mpg15_ldo_cmn(_num, L##_num##S_CTRL,	\
					_n_volt, _grp,			\
					L##_num##S_CTRL, GENMASK(7, 6))
 ...
 */
#define regulator_desc_s2mpg15_buck_cmn(_id, _sfx, _vsel_reg,	\
					    _n_volt, _grp, _en_reg, _en_mask)	\
	[S2MPG15_BUCK##_id] = {						\
		.name		= "buck" #_sfx,				\
		.of_match	= of_match_ptr("buck" #_sfx),		\
...
static const struct regulator_desc s2mpg15_regulators[] = {
	...
	regulator_desc_s2mpg15_ldo_cmn(1, L1S_CTRL, 128, 4, LDO_CTRL1, GENMASK(1, 0)),
	regulator_desc_s2mpg15_ldo_cmn(2, L2S_CTRL, 64, 4, LDO_CTRL1, GENMASK(3, 2)),
	regulator_desc_s2mpg15_ldo_opmode(3, 64, 5),
	regulator_desc_s2mpg15_ldo(4, 64, 6),
	regulator_desc_s2mpg15_ldo(5, 64, 7),
	regulator_desc_s2mpg15_ldo(6, 64, 7),
	regulator_desc_s2mpg15_ldo(7, 64, 6),
	regulator_desc_s2mpg15_ldo(8, 64, 7),
	regulator_desc_s2mpg15_ldo(9, 64, 5),
	regulator_desc_s2mpg15_ldo(10, 64, 6),
	regulator_desc_s2mpg15_ldo(11, 64, 6),
	regulator_desc_s2mpg15_ldo(12, 64, 6),
	regulator_desc_s2mpg15_ldo_opmode(13, 64, 6),
	regulator_desc_s2mpg15_ldo(14, 64, 6),
	regulator_desc_s2mpg15_ldo(15, 64, 7),
	regulator_desc_s2mpg15_ldo(16, 64, 7),
	regulator_desc_s2mpg15_ldo(17, 64, 6),
	regulator_desc_s2mpg15_ldo_opmode(18, 64, 7),
	regulator_desc_s2mpg15_ldo_opmode(19, 64, 6),
	regulator_desc_s2mpg15_ldo_opmode(20, 64, 6),
	regulator_desc_s2mpg15_ldo(21, 64, 5),
	regulator_desc_s2mpg15_ldo(22, 64, 6),
	regulator_desc_s2mpg15_ldo_cmn(23, L23S_CTRL, 128, 4, LDO_CTRL1, GENMASK(5, 4)),
	regulator_desc_s2mpg15_ldo_opmode(24, 64, 5),
	regulator_desc_s2mpg15_ldo(25, 64, 7),
	regulator_desc_s2mpg15_ldo(26, 64, 7),
	regulator_desc_s2mpg15_ldo_opmode(27, 64, 6),
	regulator_desc_s2mpg15_ldo(28, 64, 7),
	regulator_desc_s2mpg15_ldo(29, 64, 6),
	regulator_desc_s2mpg15_buck_cmn(1, 1s, B1S_OUT1, 256, 1, B1S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(2, 2s, B2S_OUT1, 256, 1, B2S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(3, 3s, B3S_OUT1, 256, 1, B3S_CTRL, BIT(7)),
	regulator_desc_s2mpg15_buck_cmn(4, 4s, B4S_OUT1, 256, 1, B4S_CTRL, BIT(7)),
	regulator_desc_s2mpg15_buck_cmn(5, 5s, B5S_OUT1, 256, 1, B5S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(6, 6s, B6S_OUT1, 256, 1, B6S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(7, 7s, B7S_OUT1, 256, 2, B7S_CTRL, BIT(7)),
	regulator_desc_s2mpg15_buck_cmn(8, 8s, B8S_OUT1, 256, 1, B8S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(9, 9s, B9S_OUT0, 256, 1, B9S_CTRL, BIT(7)),
	regulator_desc_s2mpg15_buck_cmn(10, 10s, B10S_OUT1, 256, 1, B10S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(11, 11s, B11S_OUT1, 256, 1, B11S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(12, 12s, B12S_OUT1, 256, 1, B12S_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(D, d, BUCKD_OUT, 256, 2, BUCKD_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(A, a, BUCKA_OUT, 256, 2, BUCKA_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(C, c, BUCKC_OUT, 256, 1, BUCKC_CTRL, GENMASK(7, 6)),
	regulator_desc_s2mpg15_buck_cmn(BOOST, boost, BB_OUT, 128, 3, BB_CTRL, GENMASK(7, 6)),
};
