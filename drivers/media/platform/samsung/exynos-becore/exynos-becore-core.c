 ...
 * debugfs, the run loop and the interrupt path, and the words it generates for
 * a register no parameters buffer describes.  exynos-becore-params.c holds the
 * parameters node and the encoders that read one.  exynos-becore-common.h is
 * what they share; exynos-becore-regs.h is the silicon.
 */
